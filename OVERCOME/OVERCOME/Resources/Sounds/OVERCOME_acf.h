...
#define CRI_OVERCOME_ACF_NUM_CATEGORIES_PER_PLAYBACK (4)
#define CRI_OVERCOME_ACF_CATEGORYNUM (1)
#define CRI_OVERCOME_ACF_AISACCONTROLNUM (16)
#define CRI_OVERCOME_ACF_GLOBALAISACNUM (0)
#define CRI_OVERCOME_ACF_VOICELIMITGROUPNUM (1)
#define CRI_OVERCOME_ACF_DSPSETTINGNUM (1)
#define CRI_OVERCOME_ACF_DSPSETTINGSNAPSHOTNUM (0)
#define CRI_OVERCOME_ACF_DSPBUSNAMENUM (1)
#define CRI_OVERCOME_ACF_GAMEVARIABLENUM (1)
#define CRI_OVERCOME_ACF_SELECTORNUM (0)
